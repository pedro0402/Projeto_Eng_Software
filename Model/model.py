...
class InventoryModel:
    ...
    def get_product_by_name(self, name: str) -> Optional[Tuple]:
        """Obtém um produto pelo seu nome."""
        query = "SELECT * FROM products WHERE name = ?"
        cursor = self.execute_query(query, (name,))
        return cursor.fetchone() if cursor else None

    def add_product(self, name: str, quantity: int, sector: str):
    ...
    def subtract_product_quantity_by_id(self, product_id: int, quantity: int):
